...
const FaqsSection = () => {
  ...
  return (
    <section className="max-w-full w-full px-4 sm:px-6 lg:px-8 py-20 bg-linear-to-t from-black via-gray-950 to-gray-900">
      <div className="max-w-7xl w-full mx-auto text-white">
            ...
            >
              ...
              >
                <div className="flex items-center gap-4 flex-1 pointer-events-none">
                  <span className="shrink-0 w-8 h-8 flex items-center justify-center rounded-full bg-amber-500/20 text-amber-400 font-bold text-sm">
                    {index + 1}
                  </span>
        ...
        <div className="text-center mt-16">
          ...
          <Link
            to={"/contact"}
            className="group px-8 py-4 bg-linear-to-r from-amber-600 to-amber-700 text-white rounded-xl font-bold hover:from-amber-700 hover:to-amber-800 transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-amber-900/80 inline-block"
          >
