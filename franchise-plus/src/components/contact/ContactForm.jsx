...
const ContactForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Google Sheet integration yahan connect hoga
      ...
      <div className="max-w-4xl mx-auto px-6 text-white">
        ...
        >
          ...
          <div className="pt-4">
            <button
              type="submit"
              className="w-full sm:w-auto px-10 py-4 rounded-lg bg-gradient-to-r from-amber-600 to-amber-700 font-bold text-white hover:from-amber-700 hover:to-amber-800 transition-all duration-300 hover:scale-[1.02] shadow-lg hover:shadow-amber-900/70 cursor-pointer"
            >
              Submit Inquiry
            </button>
          </div>
